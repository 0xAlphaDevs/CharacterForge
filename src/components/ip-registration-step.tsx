...
export default function IPRegistrationStep({ data, onPrev }: IPRegistrationStepProps) {
      ...
      <Card className="bg-gray-900 border-gray-800">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-white">Your Character is Ready!</CardTitle>
          </div>
          <CardDescription className="text-gray-400">
            Review your generated character and register it as IP on Story Protocol
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="flex justify-center">
            <div className="relative">
              <Image
                src={data.generatedImage || "/placeholder.svg?height=400&width=400"}
                alt="Generated Character"
                width={400}
                height={400}
                className="rounded-lg border-2 border-purple-400/50"
              />
              <Badge className="absolute top-2 right-2 bg-green-500/90 text-white">Generated</Badge>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="space-y-2">
                <p className="text-gray-300">
                  <span className="text-purple-400">Name:</span> {data.name || "Unnamed Character"}
                </p>
                <p className="text-gray-300">
              ...
              <div className="space-y-2">
                <p className="text-gray-300">
                  <span className="text-blue-400">Art Style:</span> {data.artStyle}
                </p>
                <p className="text-gray-300">
              ...
              <div className="text-center space-y-4">
                <div className="bg-green-500/20 border border-green-500/50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-300">
                    Your character is now protected as intellectual property on Story Protocol
                  </p>
                  <p className="text-xs text-gray-400 mt-2">
                    IP ID: SP-{Math.random().toString(36).substr(2, 9).toUpperCase()}
                  </p>
                </div>
              </div>
            )}
